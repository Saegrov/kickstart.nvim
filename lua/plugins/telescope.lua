...
return { -- Fuzzy Finder (files, lsp, etc)
  ...
  config = function()
    ...
    vim.keymap.set('n', '<leader>sf', function() builtin.find_files { path_display = { truncate = 5 }, hidden = true } end, { desc = '[S]earch [F]iles' })
    ...
    vim.keymap.set('n', '<leader>bs', builtin.lsp_document_symbols, { desc = '[B]uffer [S]ymbols' })
